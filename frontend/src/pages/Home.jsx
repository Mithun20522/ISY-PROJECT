...
<div>
    <div className="flex mx-5 justify-between items-center gap-5">
        <div className="bg-slate-100 border mx-10 p-7  space-y-5 mt-10 rounded-2xl shadow-lg">
            <div className="">
          ...
          <div className="bg-slate-100 border p-7 mx-10  space-y-5 mt-10 rounded-2xl shadow-lg">
            <div>
